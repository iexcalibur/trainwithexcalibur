/* Training-week plan data (shared with the site version) */
const PLAN = [
  {
    id: 'mon', short: 'MON', focus: 'Legs', target: [80,95], num: '01', name: 'Monday',
  ...
  {
    id: 'tue', short: 'TUE', focus: 'Chest', target: [80,90], num: '02', name: 'Tuesday',
  ...
  {
    id: 'wed', short: 'WED', focus: 'Back', target: [85,95], num: '03', name: 'Wednesday',
  ...
  {
    id: 'thu', short: 'THU', focus: 'Shoulders', target: [80,90], num: '04', name: 'Thursday',
  ...
  {
    id: 'fri', short: 'FRI', focus: 'Arms', target: [80,90], num: '05', name: 'Friday',
